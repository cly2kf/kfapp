...
public class RecyclerViewUtils
{
	...
	public static void setHeaderView(RecyclerView recyclerView, View view)
	{
		...
		if (recyclerView.getWidth() > 0 && recyclerView.getHeight() > 0)
		{
			view.setLayoutParams(
				new RecyclerView.LayoutParams(recyclerView.getWidth(), ViewGroup.LayoutParams.MATCH_PARENT));
		}
	...
	public static void setHeaderViewWrap(RecyclerView recyclerView, View view)
	{
		...
		{
			view.setLayoutParams(
				new RecyclerView.LayoutParams(recyclerView.getWidth(), ViewGroup.LayoutParams.WRAP_CONTENT));
		}
