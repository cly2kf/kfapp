...
package talex.zsw.baselibrary.view.FoldableLayout;
...
public class FoldableLayout extends RelativeLayout
{
	 ...
	 * @param context is a valid context.
	 */
	public FoldableLayout(Context context, int mPaddingHeight)
	{
		super(context);
		setupView(context);
	...
	public void foldWithAnimation()
	{
		if (!mIsAnimating)
		{
			...
			rotatedAboveBitmap = Bitmap
				.createBitmap(mDetailBottomBitmap, 0, 0, mDetailBottomBitmap.getWidth(),
			...
			animator.addListener(new Animator.AnimatorListener()
			{
				...
				public void onAnimationStart(Animator animation)
				{
					...
					setImageBackground(mImageViewAbove,
						new BitmapDrawable(getResources(), rotatedAboveBitmap));
					setImageBackground(mImageViewBelow,
						new BitmapDrawable(getResources(), mDetailTopBitmap));
	...
	private void computeBitmaps()
	{
		if (mDetailBitmap == null)
		{
			...
			mDetailTopBitmap = Bitmap.createBitmap(mDetailBitmap, 0, 0, mDetailBitmap.getWidth(),
				mDetailBitmap.getHeight() / 2 - mPaddingHeight);
			mDetailBottomBitmap = Bitmap
				.createBitmap(mDetailBitmap, 0, mDetailBitmap.getHeight() / 2,
					mDetailBitmap.getWidth(),
