package talex.zsw.baselibrary.view.SweetSheet.viewhandler;
...
public class MenuListViewHandler {
    ...
    public View onCreateView(ViewGroup container) {
        if(mView == null){
            mView =LayoutInflater.from(container.getContext()).inflate(R.layout.sweetsheet_layout_grid_menu,container,false);
            onViewCreated(mView);
        }
        return mView;
    }
