package talex.zsw.baselibrary.view.SweetSheet.adapter;
...
import talex.zsw.baselibrary.view.SweetSheet.listener.SingleClickListener;
...
public class MenuRVAdapter extends RecyclerView.Adapter<MenuRVAdapter.MenuVH> {
    ...
    public MenuRVAdapter(List<MenuEntity> dataLis, SweetSheet.Type type) {
        ...
        if (type == SweetSheet.Type.RecyclerView) {
            mItemLayoutId = R.layout.item_sweetsheet_horizon_rv;
        } else {
            mItemLayoutId = R.layout.item_sweetsheet_vertical_rv;
        }
    }
