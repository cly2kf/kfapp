 ...
 * @author King
 */
@SuppressWarnings("ALL") public class OverNestedScrollView extends NestedScrollView
{
	...
	public OverNestedScrollView(Context context, AttributeSet attrs, int defStyle)
	{
...
//		if (!isOverScrolled() && (ev.getAction() == MotionEvent.ACTION_MOVE || isInertance))
		if (!isOverScrolled())
		{
			mLastMotionY = (int) ev.getY();
			return super.onTouchEvent(ev);
