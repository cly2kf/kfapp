...
public class CustomNumberPick extends RelativeLayout
{
	...
	private void initView(int menuViewID, AttributeSet attrs)
	{
		...
		mEditWidth =
			typedArray.getDimension( R.styleable.CustomNumberPick_CNP_EditWidth, density * 40 );
		mWidth = typedArray.getDimension( R.styleable.CustomNumberPick_CNP_Width, density * 25 );
		mHeight = typedArray.getDimension( R.styleable.CustomNumberPick_CNP_Height, density * 25 );
