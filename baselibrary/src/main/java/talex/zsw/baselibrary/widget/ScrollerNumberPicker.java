...
public class ScrollerNumberPicker extends View
{
	...
	private void init(Context context, AttributeSet attrs)
	{
		...
		unitHeight = (int) attribute.getDimension(
				R.styleable.ScrollerNumberPicker_SNP_unitHigh, 32);
		normalFont = attribute.getDimension(
				R.styleable.ScrollerNumberPicker_SNP_normalTextSize, 14.0f);
		selectedFont = attribute.getDimension(
				R.styleable.ScrollerNumberPicker_SNP_selectedTextSize, 22.0f);
		itemNumber = attribute.getInt(
				R.styleable.ScrollerNumberPicker_SNP_itemNumber, 7);
		normalColor = attribute.getColor(
				R.styleable.ScrollerNumberPicker_SNP_normalTextColor, 0xff000000);
		selectedColor = attribute.getColor(
				R.styleable.ScrollerNumberPicker_SNP_selectedTextColor, 0xffff0000);
		lineColor = attribute.getColor(
				R.styleable.ScrollerNumberPicker_SNP_lineColor, 0xff000000);
		maskHight = attribute.getDimension(
				R.styleable.ScrollerNumberPicker_SNP_maskHigh, 48.0f);
		noEmpty = attribute.getBoolean(
				R.styleable.ScrollerNumberPicker_SNP_noEmpty, false);
		isEnable = attribute.getBoolean(
				R.styleable.ScrollerNumberPicker_SNP_isEnable, true);
		attribute.recycle();
